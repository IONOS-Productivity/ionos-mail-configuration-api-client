...
*StatsAPIApi* | [**updateStats**](docs/Api/StatsAPIApi.md#updatestats) | **PUT** /addons/{brand}/{extRef}/stats | Reports the current active user count from the Nextcloud instance to PSS
...
- [StatsUpdateRequest](docs/Model/StatsUpdateRequest.md)
...
- API version: `2.0.0-20260429080405`
