    ...
    */
    ...
    public function setServicePassword($servicePassword)
    {
        ...
        if ((mb_strlen($servicePassword) < 1)) {
            throw new \InvalidArgumentException('invalid length for $servicePassword when calling MailCreateData., must be bigger than or equal to 1.');
        }
    ...
    public function setUserPassword($userPassword)
    {
        ...
        if ((mb_strlen($userPassword) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userPassword when calling MailCreateData., must be bigger than or equal to 1.');
        }
