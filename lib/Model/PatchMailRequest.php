 ...
 *
 * The version of the OpenAPI document: 2.0.0-20251106112358
 ...
 */
class PatchMailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchMailRequest';
    ...
    public const PATH_MAILADDRESS = '/mailaddress';
    public const PATH_USERPASSWORD = '/userpassword';
    public const PATH_SERVICEPASSWORD = '/servicepassword';
    ...
    {
        return [
            self::PATH_MAILADDRESS,
            self::PATH_USERPASSWORD,
            self::PATH_SERVICEPASSWORD,
        ];
    }
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PatchMailRequest., must be bigger than or equal to 1.');
        }
